...
| 49  | **Document notes/comments**                            | User-added notes and annotations on documents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 50  | **Pre-built binaries**                                 | Release binaries for major platforms (Linux amd64/arm64)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 51  | **MySQL / MariaDB database backend**                   | Additional database backend support                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 52  | **User preferences**                                   | Theme, pagination defaults, notification settings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 53  | **Email ingestion**                                    | IMAP inbox scanning                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 54  | **Document relationships**                             | Parent/child, cross-references between documents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 55  | **Contributing guide & issue templates**               | `CONTRIBUTING.md`, issue/PR templates, and GitHub community setup to encourage contributions                                                                                                                                                                                                                                                                                                                                                                                                                                             |
