...
| 2   | **Continue interrupted tasks**           | For multitude reasons, tasks may fail and need to be retried. Also, when setup wizard is waiting for running tasks to complete, it should be able to continue where it left off |
