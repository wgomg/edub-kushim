...
- **Post-normalization tag filtering** (`FilterTags`) — rule-based validator drops >3-word tags, tags matching person names, and tags that restate the title, then caps at `maxTags` (5). Prompt over-requests 8 tags to survive filtering.
...
| 51  | **Pre-built binaries**                                 | Release binaries for major platforms (Linux amd64/arm64)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 52  | **MySQL / MariaDB database backend**                   | Additional database backend support                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 53  | **User preferences**                                   | Theme, pagination defaults, notification settings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 54  | **Email ingestion**                                    | IMAP inbox scanning                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 55  | **Document relationships**                             | Parent/child, cross-references between documents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 56  | **Contributing guide & issue templates**               | `CONTRIBUTING.md`, issue/PR templates, and GitHub community setup to encourage contributions                                                                                                                                                                                                                                                                                                                                                                                                                                             |
