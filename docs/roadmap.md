...
| 2   | **Continue interrupted tasks**           | Tasks may fail for various reasons and need to be retried. Additionally, when the setup wizard awaits running tasks to complete, it should resume from where it left off rather than starting over. |
