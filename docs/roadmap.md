...
| 40  | **Auto-detect OCR languages from LLM**      | LLM-detected document language from enrichment is cross-checked against configured OCR languages. Missing languages are added to config automatically, improving OCR accuracy without manual intervention. See [report](.kilo/reports/auto-detect-ocr-languages.md).                                                                                                                                |
| 41  | **Setup creates initial admin user**                   | `kushim setup` (CLI + wizard) prompts for admin username + password before completion, creates user via `service.User.Create()`. Session secret auto-generated and persisted during setup.                                                                                                                                                                                                             |
| 42  | **API keys**                                           | Key generation/revocation/rotation, Bearer token validation middleware, per-user key management                                                                                                                                                                                                                                                                                                        |
| 43  | **Roles and permissions**                              | RBAC schema with admin/editor/viewer roles, permission enforcement middleware, role assignment                                                                                                                                                                                                                                                                                                         |
| 44  | **Document notes/comments**                            | User-added notes and annotations on documents                                                                                                                                                                                                                                                                                                                                                          |
| 45  | **Pre-built binaries**                                 | Release binaries for major platforms (Linux amd64/arm64)                                                                                                                                                                                                                                                                                                                                               |
| 46  | **MySQL / MariaDB database backend**                   | Additional database backend support                                                                                                                                                                                                                                                                                                                                                                    |
| 47  | **User preferences**                                   | Theme, pagination defaults, notification settings                                                                                                                                                                                                                                                                                                                                                      |
| 48  | **Email ingestion**                                    | IMAP inbox scanning                                                                                                                                                                                                                                                                                                                                                                                    |
| 49  | **Document relationships**                             | Parent/child, cross-references between documents                                                                                                                                                                                                                                                                                                                                                       |
| 50  | **Contributing guide & issue templates**               | `CONTRIBUTING.md`, issue/PR templates, and GitHub community setup to encourage contributions                                                                                                                                                                                                                                                                                                           |
