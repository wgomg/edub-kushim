...
| `/tags`           | `tags/+page.svelte`           | Tag management: list, filter, create, edit, delete — name-only form via Modal.svelte. Create/Edit/Delete buttons hidden for viewer role.                            |
| `/people`         | `people/+page.svelte`         | People management with two tabs: **People** (name + native name, cascade delete warning) and **Person Types** (name + description, conflict handling). Create/Edit/Delete buttons hidden for viewer role. |
| `/document-types` | `document-types/+page.svelte` | Document type management: list, create, edit, delete — name + description form with 409 conflict handling. Create/Edit/Delete buttons hidden for viewer role.       |
