...
<div class="space-y-4">
	<div class="flex items-center justify-between">
		...
		{#if !authStore.authEnabled() || authStore.isEditor()}
			<button
				onclick={openNew}
				class="rounded-lg bg-gold-500 px-4 py-2 text-sm font-medium text-clay-950 hover:bg-gold-600 focus-visible:ring-2 focus-visible:ring-gold-500 focus-visible:ring-offset-2 focus-visible:ring-offset-clay-950 focus-visible:outline-none"
			>
				New Document Type
			</button>
		{/if}
	...
	<div class="overflow-x-auto rounded-lg border border-clay-800">
		<table class="w-full table-auto text-sm">
			<thead class="sticky top-0 bg-clay-900 text-left text-parchment-400">
				<tr>
					<th class="px-4 py-3 font-medium whitespace-nowrap" scope="col">Name</th>
					<th class="px-4 py-3 font-medium whitespace-nowrap" scope="col">Description</th>
					<th class="px-4 py-3 font-medium whitespace-nowrap" scope="col">Documents</th>
					<th class="w-[1%] px-4 py-3 font-medium whitespace-nowrap" scope="col">Actions</th>
				</tr>
			</thead>
		...
		<div class="space-y-4">
			<div>
				...
				<input
					...
					class="w-full rounded-md border border-clay-700 bg-clay-900 px-3 py-1.5 text-sm text-parchment-200 placeholder-parchment-600 focus:border-gold-500 focus:ring-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-500"
				/>
			</div>
			<div>
