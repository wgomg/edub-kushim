...
func (s *People) List(ctx context.Context, limit, offset int64) ([]database.People, error) {
...
func (s *People) Search(ctx context.Context, prefix string, limit int64) ([]database.People, error) {
